...
Grundlage ist das Plugin von **Christian Woerstenfeld**, Stand 2022.01.29,
Apache-Lizenz 2.0
([Woersty/LoxBerry-Plugin-APC-UPS](https://github.com/Woersty/LoxBerry-Plugin-APC-UPS) ·
[LoxBerry-Wiki](https://wiki.loxberry.de/plugins/apc_ups/start)).
...
identifiziert ein Plugin über genau diese beiden Felder.
