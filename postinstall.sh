...
/bin/sed -i "s#REPLACEBYSUBFOLDER#$ARGV3#"                    $ARGV5/config/plugins/$ARGV3/apc_ups.cfg
/bin/sed -i "s#REPLACEBYNAME#$ARGV2#"                         $ARGV5/config/plugins/$ARGV3/apc_ups.cfg
...
/bin/sed -i "s#REPLACEBYSUBFOLDER#$ARGV3#"                    /tmp/uploads/$ARGV1/postroot.sh
/bin/sed -i "s#REPLACEBYBASEFOLDER#$ARGV5#"                   /tmp/uploads/$ARGV1/postroot.sh
